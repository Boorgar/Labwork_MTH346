# Find x such that x^2 mod n = a
# Case 1: a = 448, n= 673
# Case 2: a = 448, n= 673^2
# Case 3: a = 448, n= 2019^3
...
print(tonelli_shanks(448, 673))
print(tonelli_shanks(448, 673**2))
print(tonelli_shanks(448, 2019**3))
print(tonelli_shanks(-1, 2029))
